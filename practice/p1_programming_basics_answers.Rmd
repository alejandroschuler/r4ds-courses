...
# TODO: Provide an appropriate x and y labels for the histogram
...
ggplot(df_patient, aes(x = HEALTHCARE_EXPENSES)) +
  ...
  labs(title = "Cost of Healthcare",
       x = "Patient Healthcare Expense ($)",
       y = "Frequency")
```

Please comment on the distribution of healthcare expenses.

**POSSIBLE ANS.** Generally speaking, healthcare expenses appear to have a rightward skew. Few patients appear to have particularly high expenses. The distribution of healthcare expenses also appears to be bimodal, with peaks near \$100,000 and \$1.3M.
...
# TODO: Provide an appropriate x and y labels for the bar chart
# TODO: Provide an appropriate title for the bar chart
ggplot(counts, aes(x = race, y = count)) +
  geom_col(fill = "steelblue") +
  labs(title = "Distribution of Races in Patient Records",
       x = "Race",
       y = "Count") +
  theme_minimal()
```
...
**Possible ANS.** Most patients in the data set belong to the `white` race category.
