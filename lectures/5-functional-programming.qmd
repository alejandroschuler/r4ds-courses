...
```{r}
url_start = "https://raw.githubusercontent.com/alejandroschuler/r4ds-courses/mph-nhanes/data/nhanes/"
files = list(
  exams      = "nhanes_monthly_exams.csv",
  components = "nhanes_monthly_components.csv",
  dates      = "nhanes_exam_dates.csv"
)
...
```{r, include=F, eval=F}
library(glue)
url = "https://raw.githubusercontent.com/alejandroschuler/r4ds-courses/mph-nhanes/data/results"
