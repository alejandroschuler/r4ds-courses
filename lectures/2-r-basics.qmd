...
```{r, eval=F}
ggplot(nhanes) + 
  geom_bar(aes(x = race, fill = diabetes))
```
...
- This code *assigns* the result of running `read_csv("https://raw.githubusercontent.com/alejandroschuler/r4ds-courses/mph-nhanes/data/nhanes/nhanes_subset.csv")` to the name `nhanes`
...
:::
:::{.column}
![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/x_gets_1.png?raw=true)
:::
::::
...
![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/x_is_1.jpg?raw=true)
...
::::{.columns}
:::{.column}
![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/y_gets_x.png?raw=true)
:::
:::{.column}
![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/x_changes.png?raw=true)
:::
::::
...
```
aes(x=bmi, y=waist_cm)
```

![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/call.png?raw=true)
...
```{r, tidy=F}
ggplot(data=nhanes) + 
  geom_point(mapping=aes(y=bmi, x=waist_cm))
```
...
```{r setup, eval=FALSE}
file_name = "https://raw.githubusercontent.com/alejandroschuler/r4ds-courses/mph-nhanes/data/nhanes/nhanes_subset.csv"
nhanes_10 = read_csv(file_name, n_max=10) # only read in 10 rows
nhanes = read_csv(file_name) 
```
...
```{r, tidy=F}
ggplot(the_data=nhanes) + 
  geom_point(mapping=aes(y_axis=bmi, x_axis=waist_cm))
```
...
![](https://github.com/alejandroschuler/r4ds-courses/blob/mph-nhanes/figures/x_squared.png?raw=true)
