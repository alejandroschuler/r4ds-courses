...
I want a single blood pressure number for each participant instead of four separate readings. Using the NHANES data, create a new column containing the average of the four systolic readings. (This is exactly what NHANES itself reports as the participant's systolic blood pressure.)
